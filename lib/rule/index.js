...
function ruleClass () {
    ...
    self.ACTION     = ACTION          = new ACTION_CLASS();
    self.CONDITION  = CONDITION       = new CONDITION_CLASS();
...
ruleClass.prototype._initRule     = function (msg, ruleObj) {
    ...
    /*
     Called when ever a new rule is being applied to the rule engine.
     */
...
ruleClass.prototype._exitRE       = function (msg) {
    ...
    /*
     Helper function to exit the rule engine .. called when all rules have been
     executed or an action has been set to exit the RE.
     */
...
ruleClass.prototype._checkDecision = function (msg, rule) {
    ...
    /*
     Called every time apply rule is called, helps in flow control.
    */
...
ruleClass.prototype._getClientMeta = function (msg) {
    ...
    /*
     Passes useful statistics back to the caller from the rule engine .
    */
...
ruleClass.prototype.executeRules = function(callback, msg, tag) {
    ...
    */
    ...
    /*
     If reHash is null, it is indicative of the fact that the rule engine contains no
     rule set for it to execute . Return the message as is .
     */
